    ...
    >
      <div className="border-b border-slate-100 px-4 py-5 sm:px-6 lg:px-8 lg:py-6">
        ...
        <h3 className="mt-6 text-lg font-semibold text-slate-900 sm:text-xl">
          Help Us Review Your Scenario Faster
        </h3>
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600">
          Optional details help our team prepare for your conversation. Each answer strengthens
          your profile for a faster, more personalized review.
        </p>
