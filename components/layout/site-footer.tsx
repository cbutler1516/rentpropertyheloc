    ...
    <footer className="border-t border-slate-200 bg-white pb-[max(3rem,env(safe-area-inset-bottom))] pt-12 md:pb-12">
      <Container>
        ...
        <div className="mt-10 border-t border-slate-200 pt-6 sm:mt-12">
          <p className="text-xs leading-relaxed text-slate-500">{FOOTER_PLATFORM_DISCLOSURE}</p>

          <div className="mt-4 flex flex-wrap gap-x-4 gap-y-1 text-xs text-slate-500">
            <FooterNavLink href={PRIVACY_POLICY_PATH} className="text-slate-500 hover:text-slate-700">
              Privacy Policy
            </FooterNavLink>
