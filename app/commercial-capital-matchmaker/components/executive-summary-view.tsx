    ...
    <div className="space-y-14 md:space-y-16">
      <div className="flex flex-wrap items-start justify-between gap-6">
        <div className="max-w-2xl space-y-4">
          <p className={ccmGoldLabel}>Executive summary</p>
      ...
      <article
        className={`${ccmPanelElevated} space-y-0 overflow-hidden print:bg-white print:text-black print:shadow-none`}
      >
        <header className="space-y-5 px-8 py-10 md:px-14 md:py-12 print:border-b print:border-zinc-200">
          <p className={ccmAccentLabel}>Capital advisor memo</p>
        ...
        <section className="space-y-4 bg-gradient-to-r from-[#7c3aed]/10 to-transparent px-8 py-10 md:px-14 print:bg-transparent print:py-8">
          <h2 className="font-mono text-[10px] tracking-[0.22em] text-[#c9a227] uppercase">
