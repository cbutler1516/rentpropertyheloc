...
import { FOOTER_LINKS, type SiteLink } from "@/lib/site";
...
export const metadata: Metadata = {
  title: "FAQ",
  description:
    "Answers about rental property HELOC eligibility, documentation, timing, and how this site works.",
};

const FAQ_RELATED: SiteLink[] = [
  { href: PRIMARY_CTA_HREF, label: NAV_CTA_LABEL },
  ...FOOTER_LINKS.topics.slice(0, 3),
];
    ...
    <div className="section-light py-16 sm:py-20 md:py-24">
      <Container className="max-w-3xl">
        ...
        <p className="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
          Direct answers on rental eligibility, structure, and timing. Programs may be available,
