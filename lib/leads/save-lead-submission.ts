...
export function buildFunnelAnswers(lead: ScoredLeadCreateRequest): Record<string, unknown> {
  return {
    ...
    propertyFormattedAddress: lead.propertyFormattedAddress,
...
function toSubmissionRow(
  ...
  return {
    ...
    lead_score: lead.leadScore ?? lead.qualityScore,
...
function recordFromLead(
  ...
  return {
    ...
    leadScore: lead.leadScore ?? lead.qualityScore,
...
export function submissionToLeadCreateRequest(submission: LeadSubmissionRecord): LeadCreateRequest {
  ...
  return {
    ...
    propertyFormattedAddress: String(fa.propertyFormattedAddress ?? ""),
    propertyValue,
    mortgageBalance,
